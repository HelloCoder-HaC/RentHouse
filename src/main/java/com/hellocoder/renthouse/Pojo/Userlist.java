package com.hellocoder.renthouse.Pojo;
...
public String toString() {
	return "Userlist [id=" + id + ", name=" + name + ", idcard=" + idcard
			+ ", phone=" + phone + ", user_id=" + user_id + ", apply=" + apply
			+ ", zulist=" + zulist + ", checkout=" + checkout + ", applyout="
			+ applyout + ", user=" + user + "]";
}
